...
$permissiontoadd = $user->rights->dolismq->audit->write;
$permissiontodelete = $user->rights->dolismq->audit->delete;
...
$help_url = '';
$title = $langs->trans('ListOf', $langs->transnoentitiesnoconv("Audits"));
...
if ($num == 1 && !empty($conf->global->MAIN_SEARCH_DIRECT_OPEN_IF_ONLY_ONE) && $search_all && !$page)
{
	...
	$id = $obj->rowid;
	header("Location: ".dol_buildpath('/dolismq/audit_card.php', 1).'?id='.$id);
	exit;
}
...
$newcardbutton = dolGetButtonTitle($langs->trans('New'), '', 'fa fa-plus-circle', dol_buildpath('/dolismq/audit_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);
