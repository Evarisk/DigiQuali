...
/**
 *  \file    core/modules/digiquali/survey/mod_survey_custom.php
 *  \ingroup digiquali
 *  \brief   File of class to manage mod_survey_custom numbering rules standard.
 */
...
/**
 *	Class to manage survey numbering rules custom.
 */
class mod_survey_custom extends CustomModeleNumRefSaturne
{
    /**
     * @var string Numbering module ref prefix.
     */
    public string $prefix = 'SY';
