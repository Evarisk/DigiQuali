...
/**
 *  \file    core/modules/digiquali/surveydet/mod_surveydet_custom.php
 *  \ingroup digiquali
 *  \brief   File of class to manage mod_surveydet_custom numbering rules standard.
 */
...
/**
 *	Class to manage surveydet numbering rules custom.
 */
class mod_surveydet_custom extends CustomModeleNumRefSaturne
{
    /**
     * @var string Numbering module ref prefix.
     */
    public string $prefix = 'SYR';
