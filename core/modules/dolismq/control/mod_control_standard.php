...
class mod_control_standard
{
	...
	public function getNextValue(object $object)
	{
		...
		$sql .= " FROM ".MAIN_DB_PREFIX."dolismq_control";
		...
		if ($resql) {
			...
			dol_syslog("mod_control_standard::getNextValue", LOG_DEBUG);
			return -1;
		}
		...
		dol_syslog("mod_control_standard::getNextValue return ".$this->prefix.$yymm."-".$num);
