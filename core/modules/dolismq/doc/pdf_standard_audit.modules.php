...
/**
 *  \file       core/modules/dolismq/doc/pdf_standard.modules.php
 *  \ingroup    dolismq
...
/**
 *	Class to manage PDF template standard_audit
 */
class pdf_standard_audit extends ModelePDFAudit
{
	/**
	...
	public function write_file($object, $outputlangs, $srctemplatepath = '', $hidedetails = 0, $hidedesc = 0, $hideref = 0)
	{
		...
		/*
	    if (!empty($conf->global->MAIN_GENERATE_AUDIT_WITH_PICTURE))
	    {
		...
		*/
		...
		if ($conf->dolismq->dir_output.'/audit')
		{
			...
			if ($object->specimen)
			{
				$dir = $conf->dolismq->dir_output.'/audit';
				$file = $dir."/SPECIMEN.pdf";
			} else {
				$objectref = dol_sanitizeFileName($object->ref);
				$dir = $conf->dolismq->dir_output.'/audit/'.$objectref;
