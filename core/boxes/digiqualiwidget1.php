...
/**
 * \file    core/boxes/digiqualiwidget1.php
 * \ingroup digiquali
 * \brief   Widget provided by DigiQuali
 */
 ...
 */
class digiqualiwidget1 extends ModeleBoxes
{
	/**
	 * @var string Alphanumeric ID. Populated by the constructor.
	 */
	public $boxcode = "digiqualibox";

	/**
	 * @var string Box icon (in configuration page)
	 * Automatically calls the icon named with the corresponding "object_" prefix
	 */
	public $boximg = "digiquali@digiquali";
	...
	public function __construct(DoliDB $db, $param = '')
	{
		...
		$this->hidden = ! ($user->rights->digiquali->control->read);   // Condition when module is visible by user (test on permission)
	}
