...
require_once '../../lib/digiquali_question_group.lib.php';
...
$permissiontoread   = $user->rights->digiquali->question_group->read;
$permissiontoadd    = $user->rights->digiquali->question_group->write; // Used by the include of actions_addupdatedelete.inc.php and actions_lineupdown.inc.php
$permissiontodelete = $user->rights->digiquali->question_group->delete || ($permissiontoadd && isset($object->status) && $object->status == $object::STATUS_DRAFT);
