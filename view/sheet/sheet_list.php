...
$newcardbutton = dolGetButtonTitle($langs->trans('NewSheet'), '', 'fa fa-plus-circle', dol_buildpath('/dolismq/view/sheet/sheet_card.php', 1).'?action=create&backtopage='.urlencode($_SERVER['PHP_SELF']), '', $permissiontoadd);
