...
saturne_header('dolismq', $action, $subaction, 1,'', $title, $help_url, '', 0, 0, $morejs, $morecss);
...
//			}
	...
	if ($includedocgeneration) {
		...
		print saturne_show_documents('dolismq:ControlDocument', $dir_files, $filedir, $urlsource, 1, 1, $object->model_pdf, 1, 0, 0, 0, 0, '', 0, '', empty($soc->default_lang) ? '' : $soc->default_lang, $object, 0, 'remove_file', (($object->status > $object::STATUS_DRAFT) ? 1 : 0), $langs->trans('ControlMustBeValidatedToGenerated'));
		print '</div>';
