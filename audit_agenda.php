...
$hookmanager->initHooks(array('auditagenda', 'globalcard')); // Note that conf->hooks_modules contains array
...
if ($object->id > 0)
{
	...
	print dol_get_fiche_head($head, 'agenda', $langs->trans("Audit"), -1, $object->picto);
