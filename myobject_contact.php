...
/**
 *  \file       dolismq/myobject_contact.php
 *  \ingroup    dolismq
...
dol_include_once('/dolismq/class/myobject.class.php');
dol_include_once('/dolismq/lib/dolismq_myobject.lib.php');
...
$permission = $user->rights->dolismq->myobject->write;
...
if ($object->id)
{
	...
	$linkback = '<a href="'.dol_buildpath('/dolismq/myobject_list.php', 1).'?restore_lastsearch_values=1'.(!empty($socid) ? '&socid='.$socid : '').'">'.$langs->trans("BackToList").'</a>';
