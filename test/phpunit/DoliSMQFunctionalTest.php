...
/**
 * \file    test/phpunit/DoliSMQFunctionalTest.php
 * \ingroup dolismq
 ...
 * @package Testdolismq
 */
class DoliSMQFunctionalTest extends \PHPUnit_Extensions_Selenium2TestCase
{
	...
	{
		$this->url('/custom/dolismq/admin/setup.php');
		$this->authenticate();
		return $this->assertContains('dolismq/admin/setup.php', $this->url(), 'Configuration page');
	}
	...
	{
		$this->url('/custom/dolismq/admin/about.php');
		$this->authenticate();
		return $this->assertContains('dolismq/admin/about.php', $this->url(), 'About page');
	}
	...
	public function testBoxDeclared()
	{
		...
		$this->authenticate();
		return $this->assertContains('dolismqwidget1', $this->source(), "Box enabled");
	}
	...
	public function testTriggerDeclared()
	{
		...
		return $this->assertContains(
			'interface_99_modDoliSMQ_DoliSMQTriggers.class.php',
	...
	public function testTriggerEnabled()
	{
		...
		return $this->assertContains(
			'tick.png',
			$this->byXPath('//td[text()="interface_99_modDoliSMQ_MyTrigger.class.php"]/following::img')->attribute('src'),
			"Trigger enabled"
		);
	}
