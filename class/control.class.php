...
class Control extends SaturneObject
{
    ...
    public $fields = [
        ...
        'fk_sheet'           => ['type' => 'integer:Sheet:digiquali/class/sheet.class.php',    'label' => 'Sheet',       'picto' => 'fontawesome_fa-list_fas_#d35968', 'enabled' => 1, 'position' => 11,  'notnull' => 1, 'visible' => 5, 'showinpwa' => 0, 'index' => 1, 'csslist' => 'minwidth100imp widthcentpercentminusxx', 'foreignkey' => 'digiquali_sheet.rowid'],
