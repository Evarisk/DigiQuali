...
class Question extends SaturneObject
{
	...
	public $fields = [
		...
		'json'                   => ['type' => 'text',         'label' => 'Json',                 'enabled' => 1, 'position' => 140, 'notnull' => 0, 'visible' => 0],
        'photo_ok'               => ['type' => 'text',         'label' => 'PhotoOK',              'enabled' => 1, 'position' => 150, 'notnull' => 0, 'visible' => 3],
		'photo_ko'               => ['type' => 'text',         'label' => 'PhotoKO',              'enabled' => 1, 'position' => 160, 'notnull' => 0, 'visible' => 3],
