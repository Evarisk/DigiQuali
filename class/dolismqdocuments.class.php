...
/**
 * \file        class/dolismqdocuments.class.php
 * \ingroup     dolismq
 * \brief       This file is a CRUD class file for DoliSMQDocuments (Create/Read/Update/Delete)
 */

require_once DOL_DOCUMENT_ROOT . '/core/class/commonobject.class.php';

/**
 * Class for DoliSMQDocuments
 */
class DoliSMQDocuments extends CommonObject
{
	/**
	 ...
	 */
	public $element = 'dolismqdocuments';

	/**
	 * @var string Name of table without prefix where object is stored. This is also the key used for extrafields management.
	 */
	public $table_element = 'dolismq_dolismqdocuments';
	...
	/**
	 * @var string String with name of icon for dolismqdocuments. Must be the part after the 'object_' into object_dolismqdocuments.png
	 */
	public $picto = 'dolismqdocuments@dolismq';
	...
	public function create(User $user, $notrigger = false, $parentObject = 0)
	{
		...
		$this->ref_ext       = 'dolismq_' . $this->ref;
