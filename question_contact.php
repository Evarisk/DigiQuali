...
/**
 *  \file       audit_contact.php
 *  \ingroup    dolismq
 *  \brief      Tab for contacts linked to Audit
 */
...
$hookmanager->initHooks(array('auditcontact', 'globalcard')); // Note that conf->hooks_modules contains array
...
$title = $langs->trans('Audit')." - ".$langs->trans('ContactsAddresses');
$help_url = '';
...
if ($object->id)
{
	...
	print dol_get_fiche_head($head, 'contact', $langs->trans("Audit"), -1, $object->picto);
